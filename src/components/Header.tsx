      ...
      <nav className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <Button 
              onClick={() => navigate('/customize-package')}
              className={`hover:scale-105 transition-all duration-300 font-semibold ${
                isScrolled 
                  ...
                  : 'bg-white text-gray-900 shadow-lg hover:bg-white/95 hover:shadow-xl'
              }`}
            >
              Plan Your Trip
            </Button>
          ...
          <div className="bg-white/95 backdrop-blur-lg rounded-xl shadow-lg border border-gray-200/50 p-4 space-y-2">
            ...
            <div className="border-t border-gray-200 pt-4 mt-2">
              ...
              <Button 
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 shadow-lg font-semibold"
              >
                Plan Your Trip
              </Button>
            </div>
