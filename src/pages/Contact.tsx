...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      link: "mailto:info@ceylonholidaytrip@gmail.com",
    },
    {
      icon: MapPin,
      title: "Address",
        ...
        <main className="pt-20">
          <section className="py-20 bg-gradient-to-br from-blue-100 via-emerald-100 to-blue-100">
            <div className="container mx-auto px-4">
              <Card className="max-w-2xl mx-auto border-2 border-green-200 shadow-xl">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              {/* Contact Information */}
              <div>
                <h2 className="text-4xl font-bold text-gray-900 mb-8 bg-gradient-to-r from-blue-600 to-emerald-600 bg-clip-text text-transparent">
                  Get in Touch
                </h2>
              ...
              {/* Contact Form */}
              <Card className="border border-gray-200 shadow-2xl rounded-lg overflow-hidden">
                  ...
                  <form className="space-y-4">
                    ...
                    <div className="pt-4">
                      <Button
                        ...
                        className="w-full py-4 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 text-lg"
                      >
                        {isSubmitting ? (
