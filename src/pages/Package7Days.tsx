  ...
  const detailedItinerary = [
    {
      ...
      activities: [
        ...
        },
        {
          ...
          highlights: ["Independence Square", "National Museum", "Pettah Market"]
        },
        {
          time: "5:00 PM",
    ...
    },
    {
      ...
      activities: [
        ...
        },
        {
          ...
          type: "activity" as const,
          highlights: ["Bullock Cart Ride", "Traditional Cooking", "Local Crafts"]
        }
      ],
    ...
    },
    {
      ...
      activities: [
        ...
        },
        {
          ...
          type: "activity" as const,
          highlights: ["Frescoes", "Mirror Wall", "Summit Palace", "360° Views"]
        },
        {
          time: "9:00 AM",
          title: "Royal Gardens",
    ...
    },
    {
      ...
      activities: [
        ...
        },
        {
          ...
          location: "Galle Fort",
          type: "sightseeing" as const,
          highlights: ["Dutch Church", "Lighthouse", "Ramparts", "Colonial Buildings"]
        },
        {
          time: "5:30 PM",
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="relative h-96 bg-gradient-to-r from-primary to-accent">
          ...
          <div className="relative container mx-auto px-4 h-full flex items-center">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
              <div className="text-white">
                ...
                <p className="text-xl md:text-2xl mb-6">7 Days of Heritage & Culture</p>
