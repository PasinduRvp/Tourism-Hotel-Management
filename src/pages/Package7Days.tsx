  ...
  const detailedItinerary = [
    {
      ...
      travelTime: "1 hour",
      activities: [
        { time: "10:00 AM", title: "Airport Pickup", description: "Meet your guide and transfer to hotel", location: "Bandaranaike International Airport", type: "transport" as const },
        { time: "12:00 PM", title: "Hotel Check-in & Lunch", description: "Settle in and enjoy traditional Sri Lankan lunch", location: "Colombo City Hotel", type: "meal" as const },
        { time: "2:30 PM", title: "Colombo City Tour", description: "Explore Independence Square, National Museum", location: "Colombo Historic District", type: "sightseeing" as const, highlights: ["Independence Square", "National Museum", "Pettah Market"] },
    ...
    },
    {
      ...
      activities: [
        { time: "7:00 AM", title: "Early Breakfast & Departure", description: "Check out and begin journey to Cultural Triangle", location: "Hotel Restaurant", type: "meal" as const },
    ...
    },
    {
      ...
      activities: [
        { time: "5:30 AM", title: "Early Start", description: "Light breakfast before the climb", location: "Hotel", type: "meal" as const },
        { time: "6:00 AM", title: "Sigiriya Rock Climb", description: "Ascend the ancient rock fortress at sunrise", location: "Sigiriya Rock", type: "activity" as const, highlights: ["Frescoes", "Mirror Wall", "Summit Palace", "360° Views"] },
        { time: "9:00 AM", title: "Royal Gardens", description: "Explore the water gardens and landscape design", location: "Sigiriya Base", type: "sightseeing" as const },
        { time: "11:00 AM", title: "Rest & Brunch", description: "Recover with refreshments and local fruits", location: "Garden Cafe", type: "meal" as const },
    ...
    },
    {
      ...
      activities: [
        { time: "8:00 AM", title: "Breakfast & Check-out", description: "Final breakfast with rock views", location: "Hotel Restaurant", type: "meal" as const },
        { time: "9:00 AM", title: "Spice Garden Visit", description: "Learn about Sri Lankan spices and cultivation", location: "Matale Spice Garden", type: "sightseeing" as const, highlights: ["Cinnamon", "Cardamom", "Vanilla", "Ayurvedic Plants"] },
        { time: "11:00 AM", title: "Continue to Kandy", description: "Drive through hill country landscapes", location: "Hill Country Route", type: "transport" as const },
        { time: "1:00 PM", title: "Kandy Arrival & Lunch", description: "Check-in and local cuisine", location: "Kandy City Hotel", type: "meal" as const },
        { time: "3:00 PM", title: "Kandy Lake Walk", description: "Peaceful stroll around the sacred lake", location: "Kandy Lake", type: "activity" as const },
    ...
    },
    {
      ...
      activities: [
        { time: "8:00 AM", title: "Breakfast at Hotel", description: "Start day with continental breakfast", location: "Hotel Restaurant", type: "meal" as const },
        { time: "9:00 AM", title: "Royal Botanical Gardens", description: "Explore Peradeniya's world-famous gardens", location: "Peradeniya", type: "sightseeing" as const, highlights: ["Orchid House", "Giant Bamboo", "Medicinal Plants", "Avenue of Royal Palms"] },
        { time: "12:00 PM", title: "Garden Picnic Lunch", description: "Enjoy lunch surrounded by nature", location: "Botanical Gardens", type: "meal" as const },
        { time: "2:00 PM", title: "Tea Factory Visit", description: "Learn about Ceylon tea production", location: "Local Tea Factory", type: "sightseeing" as const, highlights: ["Tea Processing", "Tasting Session", "Factory Tour"] },
    ...
    },
    {
      ...
      travelTime: "3 hours",
      activities: [
        { time: "8:00 AM", title: "Leisurely Breakfast", description: "Final breakfast with ocean views", location: "Hotel Terrace", type: "meal" as const },
        { time: "9:30 AM", title: "Beach Time", description: "Relax on Unawatuna Beach", location: "Unawatuna Beach", type: "activity" as const, highlights: ["Swimming", "Beach Walk", "Final Photos"] },
        { time: "11:30 AM", title: "Last-minute Shopping", description: "Purchase souvenirs and local crafts", location: "Galle Fort Shops", type: "activity" as const },
        { time: "1:00 PM", title: "Farewell Lunch", description: "Final Sri Lankan meal", location: "Beachside Restaurant", type: "meal" as const },
